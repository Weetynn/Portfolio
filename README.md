...
| 📰 [Malaysia's GDP and News Sentiment](https://github.com/Weetynn/news-sentiment-gdpmalaysia.git) | Macroeconomic Forecasting, Mandarin News Sentiment Analysis | Python & ParseHub | Investigated the use of Mandarin news sentiment to forecast Malaysia's GDP and demand components namely private investment, consumption, imports, and exports. Aimed to assess the effectiveness of Mandarin sentiment indices in predicting economic indicators, comparing their performance with prior English-language studies using machine learning models.|
