...
| 🖥️ [Payroll Management System](https://github.com/Weetynn/payroll-system.git) | Database Design | Visual Studio Code | Engineered a Python-based Payroll Management System, featuring modules for employee data management, automated salary computation, and payslip generation. Integrated business logic for data integrity and dynamic salary adjustments. Conducted rigorous testing to ensure robust functionality and an intuitive, error-tolerant interface. |
