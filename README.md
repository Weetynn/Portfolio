...
| Project | Domain | Software/Tools | Project Overview |
|--------------|-----------------|-------|---------------------|
| 🤰 [NZ's Fertility Rate](https://github.com/Weetynn/nz-fertility-tsf.git) | Time Series Forecasting | RStudio | Analyzed historical trends and future projections of New Zealand's fertility rates. Trends and stationarity were assessed using the Mann-Kendall Trend test and KPSS test.  Applied forecasting techniques, including Simple Exponential Smoothing, Holt’s Linear Trend Model, Cubic Trend Model, and ARIMA. Evaluated models using Mean Absolute Error (MAE) and Root Mean Square Error (RMSE).|
...
| 🖥️ [Payroll Management System](https://github.com/Weetynn/payroll-system.git) | Database Design | Visual Studio Code | Developed a comprehensive Payroll Management System using Python, implementing functionalities to streamline HR tasks related to employee compensation. Designed modules for employee profiles, salary calculations, and payslip generation, ensuring efficient data handling and storage. Incorporated business rules to maintain consistency across records and automate salary adjustments based on predefined criteria. Tested the system extensively to validate functionality and ensure a user-friendly, error-resistant interface. |
